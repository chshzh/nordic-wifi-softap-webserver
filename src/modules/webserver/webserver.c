...
HTTP_SERVICE_DEFINE(webserver_service, NULL, &http_service_port, 1, 10, NULL, NULL, NULL);
...
int webserver_start(void)
{
	...
	LOG_INF("Access the web interface at: http://192.168.7.1:%d", CONFIG_APP_HTTP_PORT);
